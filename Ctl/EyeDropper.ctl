VERSION 5.00
Begin VB.UserControl DropperTab 
   Alignable       =   -1  'True
   ClientHeight    =   4245
   ClientLeft      =   0
   ClientTop       =   0
   ...
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   274
   ToolboxBitmap   =   "EyeDropper.ctx":0000
...
Public Property Get Items() As EDItems
Attribute Items.VB_Description = "Items Collection"

    Set Items = m_EyeDropperItems
...
Debug.Print sKey
            ...
            ElseIf InStr(1, sKey, "¦") Then
                m_strSelectedKey = Replace$(sKey, "¦", vbNullString)
                RaiseEvent ItemSelected(Me.Items(m_strSelectedKey))
